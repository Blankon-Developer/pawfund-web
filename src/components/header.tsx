...
export function Header() {
  ...
  return (
    <header className="sticky top-4 z-50 mx-auto mt-4 flex w-[calc(100%-1rem)] min-w-62.5 items-center justify-between rounded-full bg-card p-2 pl-5 sm:w-[calc(100%-2rem)]">
      <Link href={"/"}>
        <Image
