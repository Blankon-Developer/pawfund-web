  ...
  ],
  {
    variants: {
      variant: {
        ...
        "primary-outline":
          "border-border bg-transparent text-primary dark:bg-input/30",
        "warning-outline":
          "border-border bg-transparent text-warning dark:bg-input/30",
        "success-outline":
          "border-border bg-transparent text-success dark:bg-input/30",
        "info-outline":
          "border-border bg-transparent text-info dark:bg-input/30",
        "destructive-outline":
          "border-border bg-transparent text-destructive dark:bg-input/30",
        "invert-outline":
          "border-border bg-transparent text-invert dark:bg-input/30",
        "focus-outline":
          "text-focus border-border bg-transparent dark:bg-input/30",
      },
      size: {
